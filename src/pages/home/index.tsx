            ...
            <main className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                <section className="w-full bg-white rounded-lg">
                    ...
                    <div className="border-t-3 border-[#f2d1ae] px-2 pb-2 mt-1.5">
                        ...
                        <button className="w-full mt-3 text-center font-bold rounded uppercase text-xs p-2.5 cursor-pointer bg-[#f2d1ae] text-[#313131] hover:bg-[#785539] hover:text-[#fff] transition duration-300">
                            Comprar
                        </button>
                    </div>
                </section>
